...
\begin{definition}[Multisets]
    Fix $S = \{ 1, 2, \hdots n \} $. A \textbf{multiset} on $S$ is a function $m: S \to \mathbb{N}$ where $m(\sigma)$ is the multiplicity of $\sigma \in S$. A \textbf{multiset of size $k$} is one such that 
    \[
